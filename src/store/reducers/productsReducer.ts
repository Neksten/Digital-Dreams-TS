	...
	switch (action.type) {
		...
		case FiltersActionTypes.BY_NAME:
			return {
				...
				filteredProducts: sortProductsByName(state.filteredProducts.length === 0 ? state.products : state.filteredProducts),
			};
...
export const byNameFilterReducerAction = () => <ByNameAction> ({type: FiltersActionTypes.BY_NAME})
export const descendingPricesFilterReducerAction = (): DescendingPricesAction => ({type: FiltersActionTypes.DESCENDING_PRICES})
export const ascendingPricesReducerAction = (): AscendingPricesAction => ({type: FiltersActionTypes.ASCENDING_PRICES})
export const addColorFilterReducerAction = (payload: string): AddColorFilterAction => ({type: FiltersActionTypes.ADD_COLOR_FILTER, payload})
export const removeColorFilterReducerAction = (payload: string): RemoveColorFilterAction => ({type: FiltersActionTypes.REMOVE_COLOR_FILTER, payload})
export const addBrandFilterReducerAction = (payload: string): AddBrandFilterAction => ({type: FiltersActionTypes.ADD_BRAND_FILTER, payload})
export const removeBrandFilterReducerAction = (payload: string): RemoveBrandFilterAction => ({type: FiltersActionTypes.REMOVE_BRAND_FILTER, payload})
export const filterProductsReducerAction = (): FilteredProductsFilterAction => ({type: FiltersActionTypes.FILTERED_PRODUCTS})
